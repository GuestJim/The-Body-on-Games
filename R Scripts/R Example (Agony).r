...
scale_x_continuous(breaks = PULSEseq, name = "Heart Rate (bpm)", limits=c(min(PULSEseq) - 1, max(PULSEseq, 101)), minor_breaks = NULL, expand = c(0, 1), sec.axis = sec_axis(trans = ~., breaks = PULSEquart, labels = c("25%", "Median", "75%"))) + 
